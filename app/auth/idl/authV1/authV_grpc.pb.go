...
const (
	AuthService_DeliverTokenByRPC_FullMethodName = "/authV1.AuthService/DeliverTokenByRPC"
	AuthService_VerifyTokenByRPC_FullMethodName  = "/authV1.AuthService/VerifyTokenByRPC"
	AuthService_RefreshTokenByRPC_FullMethodName = "/authV1.AuthService/refreshTokenByRPC"
	AuthService_LogoutTokenByRPC_FullMethodName  = "/authV1.AuthService/LogoutTokenByRPC"
)
...
type AuthServiceClient interface {
	...
	RefreshTokenByRPC(ctx context.Context, in *RefreshTokenReq, opts ...grpc.CallOption) (*RefreshResp, error)
	LogoutTokenByRPC(ctx context.Context, in *LogoutTokenReq, opts ...grpc.CallOption) (*LogoutTokenResp, error)
}
...
func (c *authServiceClient) RefreshTokenByRPC(ctx context.Context, in *RefreshTokenReq, opts ...grpc.CallOption) (*RefreshResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RefreshResp)
...
func (c *authServiceClient) LogoutTokenByRPC(ctx context.Context, in *LogoutTokenReq, opts ...grpc.CallOption) (*LogoutTokenResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LogoutTokenResp)
	err := c.cc.Invoke(ctx, AuthService_LogoutTokenByRPC_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	RefreshTokenByRPC(context.Context, *RefreshTokenReq) (*RefreshResp, error)
	LogoutTokenByRPC(context.Context, *LogoutTokenReq) (*LogoutTokenResp, error)
...
func (UnimplementedAuthServiceServer) RefreshTokenByRPC(context.Context, *RefreshTokenReq) (*RefreshResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RefreshTokenByRPC not implemented")
}
func (UnimplementedAuthServiceServer) LogoutTokenByRPC(context.Context, *LogoutTokenReq) (*LogoutTokenResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LogoutTokenByRPC not implemented")
}
...
func _AuthService_LogoutTokenByRPC_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LogoutTokenReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).LogoutTokenByRPC(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_LogoutTokenByRPC_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).LogoutTokenByRPC(ctx, req.(*LogoutTokenReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "LogoutTokenByRPC",
			Handler:    _AuthService_LogoutTokenByRPC_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "authV.proto",
}
